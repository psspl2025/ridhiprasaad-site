      ...
      <section className="py-12">
        <div className="content max-w-3xl mx-auto">
          ...
          <p className="text-gray-700 mb-6">
            Ridhiprasaad Supplier Pvt Ltd is a trusted provider of high-quality industrial products, supporting power plants,
            process industries, and infrastructure development. Our extensive inventory and dedication to quality ensure clients
            receive only the best for their projects.
          </p>
        </div>
      </section>
